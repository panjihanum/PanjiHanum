        ...
        <div class='span12'>
          <div class='widget-box'>
            ...
            <div class='widget-content nopadding'>
              ...
              <form class='form-horizontal' method='post' action='Controller.php' name='add_users_validate' id='add_users_validate' novalidate='novalidate'>
                ...
                <div class='control-group'>
                  ...
                  <div class='controls'>
                    <input type='text' name='daerah' id='nama_users'>
                  </div>
                </div>
